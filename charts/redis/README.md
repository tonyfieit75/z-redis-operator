...
helm install <my-release> z-helm/redis --namespace <namespace>
```

Redis setup can be upgraded by using `helm upgrade` command:-

```shell
helm upgrade <my-release> z-helm/redis --install --namespace <namespace>
```
...
| redisStandalone.image | string | `"quay.io/tonyfieit75/redis:s390x-1"` |  |
